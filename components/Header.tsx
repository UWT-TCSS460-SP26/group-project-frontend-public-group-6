  ...
  const icons: Record<string, React.ReactNode> = {
    home: (
      <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M10 2L2 8.5V18h5.5v-5h5v5H18V8.5L10 2Z"
          stroke="currentColor"
          strokeWidth="1.2"
    ...
    thriller: (
      <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        />
        <path
          d="M4 4 L2 2 M16 4 L18 2 M2 10 L4 11 M18 10 L16 11"
          stroke="currentColor"
          strokeWidth="1"
          strokeLinecap="round"
        />
    ...
    profile: (
      <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        />
        <path
          d="M3 17 C3 13.7 6.1 11 10 11 C13.9 11 17 13.7 17 17"
          stroke="currentColor"
          strokeWidth="1.2"
          strokeLinecap="round"
        />
    ...
    ratings: (
      <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <polygon
          points="10,2.5 12.2,7.8 18,8.2 13.8,12 15.3,17.5 10,14.5 4.7,17.5 6.2,12 2,8.2 7.8,7.8"
          stroke="currentColor"
          strokeWidth="1.2"
          strokeLinejoin="round"
        />
